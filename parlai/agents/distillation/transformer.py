...
class TransformerGeneratorAgent(TorchDistillGeneratorAgent):
    ...
    def build_model(self, states=None):
        ...
        """
        student_model = TransformerGeneratorModel({**self.opt ,**self.opt['student_config']}, self.dict)
        model = TransformerGeneratorModel({**self.opt, **self.opt['teacher_config']}, self.dict)
