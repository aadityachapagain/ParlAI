...
class MTurkManager:
    ...
    def _init_state(self):
        ...
        if self.use_db:
            ...
            self.db_logger = MTurkDataHandler(self.task_group_id, db_filename, custom_data_dir=self.opt.get('custom_data_dir'))
            ...
            if self.onboard_function:
                ...
                if save_data is not None:
                    MTurkDataHandler.save_world_data(
                        ...
                        custom_data_dir=self.opt.get('custom_data_dir')
                    )
